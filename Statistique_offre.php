...
<div class="form-group row">
<label for="inputPassword" class="col-sm-7 col-form-label">Moyenne du temps de mission des offres :
</label>
    <div class="col-sm-1">
      <input type="text" class="form-control" id="inputPassword" NAME="output" VALUE="">
    </div>
    ...
    <div class="form-group row">
<label for="inputPassword" class="col-sm-7 col-form-label">Nombre totales des offres postées :</label>
    <div class="col-sm-1">
      <input type="text" class="form-control" id="inputPassword" NAME="output" VALUE="">
    </div>
    </div>
    ...
    <div class="form-group row">
<label for="inputPassword" class="col-sm-7 col-form-label">Compétence la plus recherchée :
</label>
    <div class="col-sm-1">
      <input type="text" class="form-control" id="inputPassword" NAME="output" VALUE="">
    </div>
    ...
    <div class="form-group row">
<label for="inputPassword" class="col-sm-7 col-form-label">La localisation la plus demandée :</label>
    <div class="col-sm-1">
      <input type="text" class="form-control" id="inputPassword" NAME="output" VALUE="">
    </div>
    </div>
