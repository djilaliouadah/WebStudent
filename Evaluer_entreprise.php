...
<div class="form-group row">
    <label for="inputPassword" class="col-3-3 col-form-label">Nom de l'entreprise :</label>
    <div class="col-sm-2">
...
<form class="bah">
<div class="form-group row">
<label for="inputPassword" class="col-3-7 col-form-label">Commentaire (Falcutatif):
</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="inputPassword" NAME="input" VALUE="" style="height:150px;">
    </div>
    </div>
    <div class="ehpa">
    <div class="col-sm-4">
